...
public class UserController {
   ...
   @GetMapping("@findWithNameOrLastName/{name}")
   public ResponseEntity<List<UserDto>> findWithNameOrLastName(@PathVariable String name){
        List<User>users = userService.findWithNameOrLastname(name);
